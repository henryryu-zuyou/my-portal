...
<section id="money">
  ...
  <details class="qa">
    ...
    <div class="ans">
      ...
      <p>我們不會在看屋前給您一個數字，因為那個數字沒有意義。實際看過、拍過、確認過屋況之後，我們會提出兩個數字：<strong>保證租金</strong>與<strong>委託年限</strong>。這兩項您同意了，其他條件再用合約細談。</p>
      <div class="key">
    ...
    <div class="ans">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><th>3. 提出方案</th><td>看保證租金與委託年限</td><td class="num">2–3 天</td></tr>
...
<script type="application/ld+json">
{
  ...
  "mainEntity":[
    ...
    {"@type":"Question","name":"包租跟代管差在哪？我該選哪一個？","acceptedAnswer":{"@type":"Answer","text":"先分兩層。第一層是代管還是包租，決定風險由誰扛；第二層是保證租金談到幾折，決定包租划不划算。（代管） 房客是屋主的房客，租約是屋主的租約。我們負責招租、帶看、收租、修繕協調、糾紛處理。 租金沒有上限，行情漲您就漲。但空租就沒有收入，房客欠租我們幫您催，不代您賠。（包租） 我們向您承租整間房，再轉租出去。您的租約對象是租寓，不是房客。 每月固定入帳，空租、欠租都跟您無關。代價是租金以市價打折計算。 兩者在錢和稅上的實際差別： 屋主收到的租金：代管 市價全額、包租 市價 5–7 折；空租期間：代管 沒有收入、包租 照付；房客欠租：代管 屋主承擔、包租 租寓承擔；服務費：代管 仲介 0.5–1 個月＋代管 10%、包租 不另收；租金能不能調漲：代管 可以，隨行情、包租 委託期間固定；房客由誰決定：代管 屋主有否決權、包租 租寓審核。 怎麼選：房子好租、地段不愁客、想保有租金上限，只是不想處理雜事 → 代管。怕空租、怕收不到錢、人在國外或工作忙、需要穩定現金流 → 包租。 簡單的判斷方式：把「市價租金 × 預估空置月數 × 欠租風險」算過一遍，如果算出來比保證租金低，包租就划算。這也是我們評估時會跟您一起看的數字。"}},
    ...
    {"@type":"Question","name":"保證租金怎麼算？大概是市價的幾成？","acceptedAnswer":{"@type":"Answer","text":"保守估計是市場行情的 5 到 7 折，實際成數要看屋況才能定。 折數太低會踩到一個稅務地雷。要適用房屋稅 1.5% 的優惠稅率，租金必須「申報租賃所得達當地租金標準」。桃園市的租金標準是房屋評定現值的 22%（104 年 7 月 1 日前竣工、適用舊標準單價的房屋）或 10%（之後竣工、適用新標準單價），兩者都要再加公告土地現值的 1.2%。以現值 80 萬的房子為例：舊標準單價要年租金 176,000 元以上才算達標，市價月租 2 萬打 7 折是 168,000，已經低於標準；新標準單價的門檻只有 80,000 元起跳，7 折甚至 5 折通常都達得到。沒達標房屋稅會被改按 3.2% 起跳課徵，一年多繳 1 萬 3,600。 影響成數的主要是這幾項： 屋況與屋齡——需要整理的程度越低，成數越高；格局與坪數——好租的格局（套房、兩房）通常條件較好；地段與交通——去化速度直接影響我們願意承擔的風險；是否附傢俱家電——附得越齊，成數越高；委託年限——期間越長，攤提成本越低，成數越高；我們不會在看屋前給您一個數字，因為那個數字沒有意義。實際看過、拍過、確認過屋況之後，我們會提出兩個數字：保證租金與委託年限。這兩項您同意了，其他條件再用合約細談。 比較的時候記得把稅一起算。包租的租金收入一樣適用租賃專法的優惠：每屋每月 6,000 元免稅額，超過的部分月租 2 萬以內可扣除 53% 必要費用。但折數壓得太低會低於租金標準、連房屋稅優惠一起丟掉，所以「折數高低」不等於「實拿高低」。"}},
