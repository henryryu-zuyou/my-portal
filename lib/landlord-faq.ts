...
<section id="start">
  ...
  <details class="qa" open>
    ...
    <div class="ans">
      <p>以<strong>市價月租 2 萬元、房屋現值 80 萬</strong>的桃園房子、屋主綜所稅率 20% 為例，一整年算完是這樣：</p>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td class="num">−25,080<br><small>220,000×57%<br>×20%</small></td>
            <td class="num">−25,600<br><small>800,000<br>×3.2%</small></td>
            <td class="num">0</td>
            <td class="num"><strong>169,320</strong></td>
          </tr>
          <tr>
      ...
      <div class="key">
        <p><strong>包租的兩列請一起看，5 折和 7 折差了 5 萬 7。</strong>不只是租金少 4 萬 8——打到 5 折時，年租金 120,000 元低於桃園市的租金標準 168,000 元，房屋稅還拿不到 1.5% 優惠，得按 3.2% 課徵，租金少了、稅又多繳。保證租金區間是市價的 <strong>5 到 7 折</strong>，實際成數必須以現場評估的屋況為準；折數落在哪裡對實拿的影響非常大，簽約前請務必確認清楚。</p>
      </div>
      ...
      <p class="law">試算假設：桃園市、房屋現值 80 萬、綜所稅率 20%、全國持有 2 戶以內、自租與代管均假設空置 1 個月。自租採 43% 必要費用率（故乘 57%）；一般代管與一般包租採每月 6,000 元免稅額＋53% 費用率（故乘 47%）；一般代管的仲介服務費以 2 年約 20,000 元攤提為每年 10,000 元，代管費為月租 10%。房屋稅率依桃園市房屋稅徵收率自治條例，租金標準為房屋評定現值 21%。<mark class="todo">上線前請找會計師覆核一次。</mark></p>
    </div>
  </details>
    ...
    <div class="ans">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><th>一般包租代管<br><small>租期 1 年以上＋申報達標</small></th><td class="num"><strong>1.5%</strong><br><small>不限戶數</small></td><td class="num"><mark class="todo">待確認</mark></td></tr>
      ...
      <table>
        ...
        <tbody>
          <tr><th>透過包租代管出租</th><td class="num"><mark class="todo">待確認</mark></td><td class="num"><mark class="todo">待確認</mark></td></tr>
      ...
      <p><strong>要拿到 1.5% 有三個條件：</strong>租期 1 年以上；在每年 3 月 22 日前向地方稅務局<strong>提出申請</strong>；隔年 5 月向國稅局申報的租賃所得<strong>達當地租金標準</strong>。租金標準是房屋評定現值乘上財政部核定的比率，桃園市 112 年度為 21%，新北市則分為 22% 與 24% 兩組（板橋等 10 區為 24%）。<mark class="todo">請向新北市稅捐稽徵處確認林口屬哪一組。</mark>沒提出申請、或申報未達標，都會改按 3.2% 起跳課徵並追補差額。</p>
      <p class="law">資料來源：桃園市政府地方稅務局「出租房屋節稅專區」（115 年 8 月更新）、桃園市房屋稅徵收率自治條例、新北市房屋稅徵收率自治條例（114 年 1 月 22 日三讀，溯及 113 年 7 月 1 日施行）、租賃住宅市場發展及管理條例、住宅法第 15、16 條。</p>
    </div>
  </details>
...
<script type="application/ld+json">
{
  ...
  "mainEntity":[
    ...
    {"@type":"Question","name":"參加後我可以省哪些稅？","acceptedAnswer":{"@type":"Answer","text":"綜合所得稅全國一致，這一塊差距最大： 每屋每月免稅額：自己出租 無、代管或包租 6,000、另具公益出租人身分 15,000；必要費用率：自己出租 43%、代管或包租 53%、另具公益出租人身分 43%。 房屋稅與地價稅則是各縣市自訂。以下是我們服務範圍內兩個縣市的實際規定： 空置，或出租但沒申請優惠稅率（其他住家用）：桃園市 3.2% – 4.8%、新北市 3.2% – 4.8%；出租且申報達租金標準：桃園市 1.5% – 2.4%、新北市 1.5% – 2.4%；一般包租代管（租期 1 年以上＋申報達標）：桃園市 1.5%、新北市 待確認；公益出租人：桃園市 1.2%、新北市 1.2%。 透過包租代管出租：桃園市 待確認、新北市 待確認；公益出租人：桃園市 2‰、新北市 2‰。 「不限戶數」是最容易被略過、但影響最大的四個字。房屋稅 2.0 採全國歸戶，持有越多戶稅率跳得越兇。但透過包租代管出租的房子，桃園市不計入戶數、直接適用單一稅率——多屋族省下的差距遠比單看稅率大。 要拿到 1.5% 有三個條件：租期 1 年以上；在每年 3 月 22 日前向地方稅務局提出申請；隔年 5 月向國稅局申報的租賃所得達當地租金標準。租金標準是房屋評定現值乘上財政部核定的比率，桃園市 112 年度為 21%，新北市則分為 22% 與 24% 兩組（板橋等 10 區為 24%）。請向新北市稅捐稽徵處確認林口屬哪一組。沒提出申請、或申報未達標，都會改按 3.2% 起跳課徵並追補差額。 資料來源：桃園市政府地方稅務局「出租房屋節稅專區」（115 年 8 月更新）、桃園市房屋稅徵收率自治條例、新北市房屋稅徵收率自治條例（114 年 1 月 22 日三讀，溯及 113 年 7 月 1 日施行）、租賃住宅市場發展及管理條例、住宅法第 15、16 條。"}},
