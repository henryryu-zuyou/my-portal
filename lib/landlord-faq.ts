...
.ask-cta{margin:14px 0 0;display:flex;flex-wrap:wrap;gap:10px}
.ask-cta a{
...
/* 結論卡 — 以 logo 三原色（綠 #68C098／藍 #2C8FD2／黃 #FFE452）標示，一題最多用一次 */
.verdict{
  position:relative;overflow:hidden;
  background:#EFF7F4;border:1px solid #CBE2D9;border-radius:10px;
  padding:18px 19px 15px;margin:4px 0 14px;
  box-shadow:0 10px 26px -18px rgba(61,69,80,.75);
}
.verdict::before{
  content:"";position:absolute;top:0;left:0;right:0;height:4px;
  background:linear-gradient(90deg,
    #68C098 0 33.34%,#2C8FD2 33.34% 66.67%,#FFE452 66.67% 100%);
}
.verdict-tag{
  display:inline-block;margin-bottom:10px;padding:3px 10px;border-radius:99px;
  font-family:var(--mono);font-size:11.5px;letter-spacing:.16em;font-weight:600;
  color:#fff;background:#3D4550;
}
.verdict p{margin:0 0 11px;font-size:16px;color:#2B3238;line-height:1.8}
.verdict p strong{color:#1B6FA6}
.verdict ul{margin:0;padding-left:0;list-style:none}
.verdict li{
  position:relative;margin:0 0 7px;padding-left:1.65em;
  font-size:15.5px;color:#2B3238;line-height:1.75;
}
.verdict li:last-child{margin-bottom:0}
.verdict li strong{color:#3D4550}
.verdict li::before{
  content:"";position:absolute;left:.25em;top:.66em;
  width:8px;height:8px;border-radius:3px;background:#68C098;
}
.verdict li:nth-child(2)::before{background:#2C8FD2}
.verdict li:nth-child(3)::before{background:#FFE452;box-shadow:inset 0 0 0 1px rgba(0,0,0,.16)}
.law{
...
<header class="hero">
  <div class="wrap">
    ...
    <p class="ask-cta"><a href="/ask">不想一題一題找？直接打字問 →</a><a href="/faq-diagrams">最難講清楚的幾題，改用圖看 →</a></p>
  </div>
</header>
...
<section id="start">
  ...
  <details class="qa" open>
    ...
    <div class="ans">
      ...
      <div class="key">
        <p><strong>包租的兩列請一起看。</strong>差的不只是租金少 4 萬 8——保證租金打得越低，越容易掉到「當地一般租金標準」以下；申報的租賃所得沒達標，房屋稅就拿不到 1.5% 優惠、得按 3.2% 起跳課徵，租金少了、稅又多繳。而<strong>這個門檻高不高，取決於房子是新還是舊標準單價</strong>（桃園市以 <strong>104 年 7 月 1 日</strong>為分界），兩種差很多，所以下面分開算。上表用的是「5 折未達標、7 折達標」這種折線情況。</p>
      </div>

      <p>同一間房子（現值 80 萬、市價月租 2 萬、綜所稅率 <span data-q1-rate>20%</span>），兩種竣工年代的結果：</p>
      <div class="tbl-scroll">
      <table>
        <thead>
          <tr><th>保證租金</th><th class="num">適用舊標準單價<br><small>104/7/1 前竣工</small></th><th class="num">適用新標準單價<br><small>104/7/1 後竣工</small></th></tr>
        </thead>
        <tbody>
          <tr>
            <th>租金標準<br><small>達標門檻</small></th>
            <td class="num">176,000 ＋土地<br><small>80 萬×22%<br>＋公告土地現值×1.2%</small></td>
            <td class="num">80,000 ＋土地<br><small>80 萬×10%<br>＋公告土地現值×1.2%</small></td>
          </tr>
          <tr data-q1b-row="d5" data-gross="120000" data-base="22560">
            <th>5 折<br><small>年租 120,000</small></th>
            <td class="num">未達標<br><small>房屋稅 3.2%</small><br>實拿 <strong><span data-q1b-net data-col="old" data-other="25600">89,888</span></strong></td>
            <td class="num">達標<br><small>房屋稅 1.5%</small><br>實拿 <strong><span data-q1b-net data-col="new" data-other="12000">103,488</span></strong></td>
          </tr>
          <tr data-q1b-row="d7" data-gross="168000" data-base="45120">
            <th>7 折<br><small>年租 168,000</small></th>
            <td class="num">未達標<br><small>房屋稅 3.2%</small><br>實拿 <strong><span data-q1b-net data-col="old" data-other="25600">133,376</span></strong></td>
            <td class="num">達標<br><small>房屋稅 1.5%</small><br>實拿 <strong><span data-q1b-net data-col="new" data-other="12000">146,976</span></strong></td>
          </tr>
          <tr>
            <th>5 折與 7 折的差距</th>
            <td class="num"><span data-q1b-gap data-col="old">4 萬 3</span></td>
            <td class="num"><span data-q1b-gap data-col="new">4 萬 3</span></td>
          </tr>
        </tbody>
      </table>
      </div>
      <p><strong>舊標準單價那一欄是重點：</strong>門檻 176,000 元已經高過 7 折的 168,000，所以<strong>不管土地現值多少、打 5 折還是 7 折，都拿不到 1.5% 優惠</strong>——老房子談包租折數，這件事一定要先算進去。新標準單價那欄則假設公告土地現值在 <strong>333 萬以內</strong>（5 折）、<strong>733 萬以內</strong>（7 折）；超過就會把門檻推高、同樣掉出達標。</p>
      <p>保證租金區間是市價的 <strong>5 到 7 折</strong>，實際成數必須以現場評估的屋況為準；折數落在哪裡對實拿的影響非常大，簽約前請務必確認清楚。</p>
      <div class="verdict">
        <span class="verdict-tag">結論</span>
    ...
    <div class="ans">
      ...
      <div class="duo">
        <div class="duo-cell a">
          ...
          <p>房客是屋主的房客，租約是屋主的租約。我們負責招租、帶看、收租、欠租催繳、修繕協調、糾紛處理。</p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><th>服務費</th><td class="num">仲介 0.5–1 個月<br>＋代管 10%</td><td class="num"><strong>不另收</strong></td></tr>
...
<section id="money">
  ...
  <details class="qa">
    <summary><span class="qid">Q4</span><span>包租保證租金怎麼算？大概是市價的幾成？</span></summary>
    <div class="ans">
      <p>保守估計是市場行情的 <strong>5 到 7 折</strong>，實際成數要看屋況才能定。</p>
      <div class="key">
        <p><strong>折數太低會踩到一個稅務地雷。</strong>要適用房屋稅 1.5% 的優惠稅率，租金必須「申報租賃所得達當地租金標準」。桃園市的租金標準是房屋評定現值的 <strong>22%</strong>（104 年 7 月 1 日前竣工、適用舊標準單價的房屋）或 <strong>10%</strong>（之後竣工、適用新標準單價），兩者都要再加公告土地現值的 1.2%。以現值 80 萬的房子為例：舊標準單價要年租金 <strong>176,000 元</strong>以上才算達標，市價月租 2 萬打 7 折是 168,000，<strong>已經低於標準</strong>；新標準單價的門檻只有 80,000 元起跳，7 折甚至 5 折通常都達得到。沒達標房屋稅會被改按 3.2% 起跳課徵，一年多繳 1 萬 3,600。</p>
      </div>
      <p>影響成數的主要是這幾項：</p>
      <ul>
      ...
      <p>我們不會在看屋前給您一個數字，因為那個數字沒有意義。實際看過、拍過、確認過屋況之後，我們會提出兩個數字：<strong>包租保證租金</strong>與<strong>委託年限</strong>。這兩項您同意了，其他條件再用合約細談。</p>
      <div class="key">
  ...
  <details class="qa">
    ...
    <div class="ans">
      ...
      <div class="key">
        <p><strong>開價落在租客願付區間內，通常一個月內可以媒合完成；超出租客願付區間，空置期會明顯拉長。</strong>而空著的每一個月都是實質損失——月租 2 萬的房子多空一個月，就等於整年少了 2 萬，這通常比當初想多爭取的那一兩千元租金還多。</p>
      </div>
  ...
  <details class="qa">
    ...
    <div class="ans">
      <p><strong>仲介服務費（一次性，成功出租才收）</strong>是 <strong>0.5 到 1 個月</strong>租金，依承租期間長短計算：</p>
      <div class="tbl-scroll">
      <table>
        <thead><tr><th>標的承租期間</th><th class="num">仲介服務費</th><th class="num">以月租 20,000 為例</th></tr></thead>
        <tbody>
          <tr><th>1 年以上未滿 2 年</th><td class="num">月租金之 50%<br><small>0.5 個月</small></td><td class="num">10,000</td></tr>
          <tr><th>2 年以上</th><td class="num">月租金之 100%<br><small>1 個月</small></td><td class="num">20,000</td></tr>
        </tbody>
      </table>
      </div>
  ...
  <details class="qa">
    ...
    <div class="ans">
      ...
      <div class="duo">
        <div class="duo-cell a">
          <span class="duo-tag">代管</span>
          <p>押金由我們代收，保管方式二擇一：<strong>租寓全額保管或屋主全額保管</strong>，於簽約時約定並寫進合約。由租寓保管的部分與公司營運帳戶分開，不動用。</p>
      ...
      <p><strong>代管的兩種保管方式怎麼選？</strong>差別在退租當天的處理速度與您的掌握感：</p>
      <ul>
  ...
  <div class="cta">
    <p>想知道您的房子能收多少？我們看過屋況後提出保證租金與委託年限，不收費。</p>
...
<section id="risk">
  ...
  <details class="qa">
    ...
    <div class="ans">
      ...
      <p><strong>降低風險的做法：</strong>入住前的現況確認書要拍得夠仔細，這是後續認定的唯一依據。</p>
    </div>
  </details>
...
<section id="fix">
  ...
  <details class="qa">
    <summary><span class="qid">Q28</span><span>火險、地震險，誰保？</span></summary>
    <div class="ans">
      <p><strong>保險的部分租寓不經手，由屋主自行處理與投保</strong>，不論代管或包租都一樣。</p>
      <p><strong>住宅火險與地震基本保險</strong>保的是屋主的房子，由屋主投保。有房貸的房子通常已由銀行要求投保，記得確認保額是否還跟得上重置成本。</p>
    </div>
  </details>
</section>
    ...
    <div class="ans">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><th>3. 提出方案</th><td>看包租保證租金與委託年限</td><td class="num">2–3 天</td></tr>
          <tr><th>4. 簽約</th><td>審閱期至少 3 日，備齊文件</td><td class="num">3–7 天</td></tr>
          <tr><th>5. 整理與上架</th><td>決定整理程度</td><td class="num">7–14 天</td></tr>
          <tr><th>6. 招租媒合</th><td>等通知</td><td class="num">開價落在願付區間內<br>約 1 個月內</td></tr>
        </tbody>
      </table>
      </div>
      <p>前三步完全免費，看完方案再決定要不要往下走。招租所需的時間主要取決於定價，租金怎麼定、誰說了算，請見 Q5。</p>
    </div>
  </details>
...
(function(){
  ...
  function render(){
    ...
    /* 新舊標準單價對照表：同一列共用年租金與課稅所得，房屋稅（data-other）兩欄不同 */
    var nets = {};
    document.querySelectorAll('[data-q1b-net]').forEach(function(el){
      var tr = el.closest('[data-q1b-row]');
      if(!tr) return;
      var v = +tr.dataset.gross - Math.round(+tr.dataset.base * rate / 100) - (+el.dataset.other);
      el.textContent = fmt(v);
      (nets[el.dataset.col] = nets[el.dataset.col] || {})[tr.dataset.q1bRow] = v;
    });
    document.querySelectorAll('[data-q1b-gap]').forEach(function(el){
      var c = nets[el.dataset.col];
      if(c && c.d5 != null && c.d7 != null) el.textContent = wan(c.d7 - c.d5);
    });
...
<script type="application/ld+json">
{
  ...
  "@type":"FAQPage",
  "mainEntity":[
    {"@type":"Question","name":"我自己租，跟交給租寓，實拿差多少？","acceptedAnswer":{"@type":"Answer","text":"以市價月租 2 萬元、房屋現值 80 萬的桃園房子、屋主綜所稅率 20% 為例，一整年算完是這樣： 自己出租（沒申請「出租房屋優惠稅率」）：年租金收入 220,000、綜所稅 −25,080、房屋稅 −25,600、服務費 0、實拿 169,320；自己出租（已申請「出租房屋優惠稅率」且達標）：年租金收入 220,000、綜所稅 −25,080、房屋稅 −12,000、服務費 0、實拿 182,920；一般代管：年租金收入 220,000、綜所稅 −14,476、房屋稅 −12,000、服務費 −32,000、實拿 161,524；一般包租（保證租金 5 折）：年租金收入 120,000、綜所稅 −4,512、房屋稅 −25,600、服務費 0、實拿 89,888；一般包租（保證租金 7 折）：年租金收入 168,000、綜所稅 −9,024、房屋稅 −12,000、服務費 0、實拿 146,976。 兩種「自己出租」的綜所稅為什麼一樣？因為兩列都有依法向國稅局申報租賃所得，差別只在有沒有另外向地方稅務局申請「出租房屋優惠稅率」。這是兩個不同的申報：綜所稅是每年 5 月報給國稅局；房屋稅優惠要在 3 月 22 日前主動向稅務局提出申請，而且隔年申報的租賃所得要達當地租金標準，兩個條件缺一不可。很多屋主有乖乖繳綜所稅，卻不知道要申請這個，白白多繳 1 萬 3,600。 包租的兩列請一起看。差的不只是租金少 4 萬 8——保證租金打得越低，越容易掉到「當地一般租金標準」以下；申報的租賃所得沒達標，房屋稅就拿不到 1.5% 優惠、得按 3.2% 起跳課徵，租金少了、稅又多繳。而這個門檻高不高，取決於房子是新還是舊標準單價（桃園市以 104 年 7 月 1 日為分界），兩種差很多，所以下面分開算。上表用的是「5 折未達標、7 折達標」這種折線情況。 同一間房子（現值 80 萬、市價月租 2 萬、綜所稅率 20%），兩種竣工年代的結果： 租金標準（達標門檻）：適用舊標準單價104/7/1 前竣工 176,000 ＋土地、適用新標準單價104/7/1 後竣工 80,000 ＋土地；5 折（年租 120,000）：適用舊標準單價104/7/1 前竣工 未達標實拿 89,888、適用新標準單價104/7/1 後竣工 達標實拿 103,488；7 折（年租 168,000）：適用舊標準單價104/7/1 前竣工 未達標實拿 133,376、適用新標準單價104/7/1 後竣工 達標實拿 146,976；5 折與 7 折的差距：適用舊標準單價104/7/1 前竣工 4 萬 3、適用新標準單價104/7/1 後竣工 4 萬 3。 舊標準單價那一欄是重點：門檻 176,000 元已經高過 7 折的 168,000，所以不管土地現值多少、打 5 折還是 7 折，都拿不到 1.5% 優惠——老房子談包租折數，這件事一定要先算進去。新標準單價那欄則假設公告土地現值在 333 萬以內（5 折）、733 萬以內（7 折）；超過就會把門檻推高、同樣掉出達標。 保證租金區間是市價的 5 到 7 折，實際成數必須以現場評估的屋況為準；折數落在哪裡對實拿的影響非常大，簽約前請務必確認清楚。 我們不會說「交給租寓一定賺比較多」。房子好租、屋主自己有時間管、又把兩邊的申報都做齊，自租的帳面數字確實不差。真正要比的是這三件事會不會發生： 多空一個月——自租少 2 萬，包租不受影響；欠租一次——押金抵完可能還少好幾萬，加上催討與訴訟的時間；漏了房屋稅那道申請——稅率從 1.5% 跳到 3.2%，這一格就差 1 萬 3,600；試算假設：桃園市、房屋現值 80 萬、綜所稅率 20%、全國持有 2 戶以內、自租與代管均假設空置 1 個月。自租採 43% 必要費用率（故乘 57%）；一般代管與一般包租採每月 6,000 元免稅額＋53% 費用率（故乘 47%）；一般代管的仲介服務費以 2 年約 20,000 元攤提為每年 10,000 元，代管費為月租 10%。房屋稅率依桃園市房屋稅徵收率自治條例；房屋稅欄假設自租與代管已申請並申報達當地一般租金標準（1.5%）、包租 5 折未達標（3.2%）、7 折達標（1.5%）。租金標準的算法自 114 年度起改制（見 Q12），個案是否達標依該屋房屋評定現值與公告土地現值認定。2026-08-31 已依 114 年度租金標準修正說法、房屋稅達標與否改列為假設；數字仍建議找會計師覆核一次。"}},
    {"@type":"Question","name":"包租跟代管差在哪？我該選哪一個？","acceptedAnswer":{"@type":"Answer","text":"先分兩層。第一層是代管還是包租，決定風險由誰扛；第二層是保證租金談到幾折，決定包租划不划算。（代管） 房客是屋主的房客，租約是屋主的租約。我們負責招租、帶看、收租、欠租催繳、修繕協調、糾紛處理。 租金沒有上限，行情漲您就漲。但空租就沒有收入，房客欠租我們幫您催，不代您賠。（包租） 我們向您承租整間房，再轉租出去。您的租約對象是租寓，不是房客。 每月固定入帳，空租、欠租都跟您無關。代價是租金以市價打折計算。 兩者在錢和稅上的實際差別： 屋主收到的租金：代管 市價全額、包租 市價 5–7 折；空租期間：代管 沒有收入、包租 照付；房客欠租：代管 屋主承擔、包租 租寓承擔；服務費：代管 仲介 0.5–1 個月＋代管 10%、包租 不另收；租金能不能調漲：代管 可以，隨行情、包租 委託期間固定；房客由誰決定：代管 屋主有否決權、包租 租寓審核。 怎麼選：房子好租、地段不愁客、想保有租金上限，只是不想處理雜事 → 代管。怕空租、怕收不到錢、人在國外或工作忙、需要穩定現金流 → 包租。 簡單的判斷方式：把「市價租金 × 預估空置月數 × 欠租風險」算過一遍，如果算出來比保證租金低，包租就划算。這也是我們評估時會跟您一起看的數字。"}},
    ...
    {"@type":"Question","name":"包租保證租金怎麼算？大概是市價的幾成？","acceptedAnswer":{"@type":"Answer","text":"保守估計是市場行情的 5 到 7 折，實際成數要看屋況才能定。 折數太低會踩到一個稅務地雷。要適用房屋稅 1.5% 的優惠稅率，租金必須「申報租賃所得達當地租金標準」。桃園市的租金標準是房屋評定現值的 22%（104 年 7 月 1 日前竣工、適用舊標準單價的房屋）或 10%（之後竣工、適用新標準單價），兩者都要再加公告土地現值的 1.2%。以現值 80 萬的房子為例：舊標準單價要年租金 176,000 元以上才算達標，市價月租 2 萬打 7 折是 168,000，已經低於標準；新標準單價的門檻只有 80,000 元起跳，7 折甚至 5 折通常都達得到。沒達標房屋稅會被改按 3.2% 起跳課徵，一年多繳 1 萬 3,600。 影響成數的主要是這幾項： 屋況與屋齡——需要整理的程度越低，成數越高；格局與坪數——好租的格局（套房、兩房）通常條件較好；地段與交通——去化速度直接影響我們願意承擔的風險；是否附傢俱家電——附得越齊，成數越高；委託年限——期間越長，攤提成本越低，成數越高；我們不會在看屋前給您一個數字，因為那個數字沒有意義。實際看過、拍過、確認過屋況之後，我們會提出兩個數字：包租保證租金與委託年限。這兩項您同意了，其他條件再用合約細談。 比較的時候記得把稅一起算。包租的租金收入一樣適用租賃專法的優惠：每屋每月 6,000 元免稅額，超過的部分月租 2 萬以內可扣除 53% 必要費用。但折數壓得太低會低於租金標準、連房屋稅優惠一起丟掉，所以「折數高低」不等於「實拿高低」。"}},
    {"@type":"Question","name":"租金怎麼定？誰說了算？","acceptedAnswer":{"@type":"Answer","text":"最終由您決定。我們提供的是依據，不是單方面丟給您一個數字。 評估方式是比對591 的在租行情與內政部實價登錄的成交紀錄，鎖定同一地段、相同坪數與格局的物件，再依屋況、樓層、朝向與是否附傢俱調整。比對用的案例會一併提供給您，您看得到我們是從哪些物件推出來的。 開價落在租客願付區間內，通常一個月內可以媒合完成；超出租客願付區間，空置期會明顯拉長。而空著的每一個月都是實質損失——月租 2 萬的房子多空一個月，就等於整年少了 2 萬，這通常比當初想多爭取的那一兩千元租金還多。 我們不會勉強您照建議價開。但如果上架後連續 2 週沒有帶看、也無人詢問，我們會主動找您把數字攤開來重新討論（見 Q27）。"}},
    ...
    {"@type":"Question","name":"服務費怎麼收？除此之外還有沒有其他費用？","acceptedAnswer":{"@type":"Answer","text":"仲介服務費（一次性，成功出租才收）是 0.5 到 1 個月租金，依承租期間長短計算： 1 年以上未滿 2 年：仲介服務費 月租金之 50%、以月租 20,000 為例 10,000；2 年以上：仲介服務費 月租金之 100%、以月租 20,000 為例 20,000。 這筆是每次成功媒合收一次，不是每年收。房客續約時的處理方式見 Q11。 代管服務費（按月）：月租金之 10%，由每月租金中扣除後撥付。空租期間不收，房子沒租出去我們一毛也拿不到。 月租 20,000 的房子，每月代管費 2,000 元，一年 24,000 元。這筆買的是招租、帶看、收租、催繳、修繕協調、糾紛處理與退租點交。（代管） 仲介服務費 ＋ 每月代管費。兩筆都會列在月結明細上。（包租） 屋主端不另收服務費。我們的收益來自轉租價差，同時承擔空置與欠租風險。 不會有的費用：簽約費、審件費、上架費、拍照費、每年續管費。除了上述兩項與經您同意的修繕支出以外，不會有其他名目。"}},
    ...
    {"@type":"Question","name":"押金由誰收、放在哪裡？退租要扣款時誰決定？","acceptedAnswer":{"@type":"Answer","text":"依《租賃住宅市場發展及管理條例》，押金不得超過 2 個月租金，這是法定上限。（代管） 押金由我們代收，保管方式二擇一：租寓全額保管或屋主全額保管，於簽約時約定並寫進合約。由租寓保管的部分與公司營運帳戶分開，不動用。 退租時的扣款金額，一律經您同意後才執行。（包租） 房客押金由我們收取與保管，屋主不經手。屋主與租寓之間另依合約約定是否有押金。 代管的兩種保管方式怎麼選？差別在退租當天的處理速度與您的掌握感： 租寓全額保管——退租當天可直接結算退還，流程最快，但您要信任公司的分戶保管；屋主全額保管——錢在自己手上最安心，但退租時須等您匯回才能退還房客，若一時聯絡不上或對扣款有異議，房客會卡在那裡；扣款流程：退租點交時全程拍照記錄，與入住時的現況確認書逐項比對，做成損壞明細與報價。屬於正常使用耗損的不扣（如牆面自然泛黃、家電自然老化）；屬於房客造成的損壞才扣。有爭議時我們居中處理，必要時可循調處或法律途徑。"}},
    ...
    {"@type":"Question","name":"押金不夠賠，超出的部分誰負擔？","acceptedAnswer":{"@type":"Answer","text":"押金上限是 2 個月租金，遇到嚴重損壞確實可能不夠。 一般代管：不足部分屬於屋主與房客之間的債權，我們協助追償——包含估價、發函、必要時協助提起訴訟或聲請支付命令。追不回來的部分由屋主承擔，這是代管模式的本質。 包租：房子還給您時應回復至點交當時的狀態（正常使用耗損除外），這是租寓對屋主的責任，不是房客對屋主的責任。 降低風險的做法：入住前的現況確認書要拍得夠仔細，這是後續認定的唯一依據。"}},
    ...
    {"@type":"Question","name":"火險、地震險，誰保？","acceptedAnswer":{"@type":"Answer","text":"保險的部分租寓不經手，由屋主自行處理與投保，不論代管或包租都一樣。 住宅火險與地震基本保險保的是屋主的房子，由屋主投保。有房貸的房子通常已由銀行要求投保，記得確認保額是否還跟得上重置成本。"}},
    ...
    {"@type":"Question","name":"整個流程要多久？","acceptedAnswer":{"@type":"Answer","text":"1. 初步諮詢：您要做的事 提供地址、坪數、格局、照片、約需時間 1–2 天；2. 現場看屋：您要做的事 約時間開門，一小時內、約需時間 3–5 天；3. 提出方案：您要做的事 看包租保證租金與委託年限、約需時間 2–3 天；4. 簽約：您要做的事 審閱期至少 3 日，備齊文件、約需時間 3–7 天；5. 整理與上架：您要做的事 決定整理程度、約需時間 7–14 天；6. 招租媒合：您要做的事 等通知、約需時間 開價落在願付區間內約 1 個月內。 前三步完全免費，看完方案再決定要不要往下走。招租所需的時間主要取決於定價，租金怎麼定、誰說了算，請見 Q5。"}},
